...
class AuthManager:
    ...
    def _get_jwt_secret(self) -> str:
        ...
        env_secret = os.environ.get("FriDay_JWT_SECRET")
        if env_secret:
...
class SecureKeyManager:
    ...
    SERVICE_NAME = "FriDay_ASSISTANT"
    KEYRING_USER = "FriDay_ai"
...
class SecureFileWriter:
    ...
    BACKUP_DIR = Path.home() / ".FriDay_backups"
...
class SecurityLogger:
    ...
    LOG_FILE = Path.home() / ".FriDay_logs" / "security.log"
