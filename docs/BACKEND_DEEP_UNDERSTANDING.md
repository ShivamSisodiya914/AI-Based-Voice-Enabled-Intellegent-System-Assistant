# FriDay Backend Deep Technical Understanding

## 1. Scope
This document is a deep technical reference for the backend/runtime side of FriDay.
...
## 2. Runtime Layers
FriDay backend is organized as layered runtime responsibilities:

1. Session Orchestration Layer
- main.py (class FriDayLive)
...
4. FriDayLive.run() enters connectivity-aware loop.
